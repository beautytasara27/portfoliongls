    ...
    <div className="flex justify-center">
      <div className="fixed z-50 top-0 w-full flex justify-center font-rubik-regular py-2 sm:py-6 bg-theme border-b  border-gray-700">
        <div className="w-full flex justify-between items-center  relative mx-4 sm:mx-6 lg:mx-8 xl:0">
                    ...
                    >
                      ...
                      <g>
                        <svg
                          ...
                          width="395.52"
                        >
                          <g transform="matrix(1,0,0,1,75.54432,62.67277430541871)">
                            <svg
                              viewBox="0 0 244.43135999999998 121.85445138916256"
                              height="121.85445138916256"
                          ...
                          <path
                            d="M240.356 56.673L240.356 9.106 11.369 9.106 11.369 238.094 240.356 238.094 240.356 190.527 229.367 190.527 229.367 227.105 22.358 227.105 22.358 20.095 229.367 20.095 229.367 56.673Z"
                            fill="#f9d74c"
                            stroke="transparent"
                            data-fill-palette-color="primary"
                          ></path>
          ...
          <header className="hidden md:flex items-center text-lg justify-end flex-grow space-x-8">
            <h2
